...
def train(env_name='LunarLander-v2', episodes=2000, gamma=0.99, lr=1e-3, max_steps=1000):
    ...
    policy_net = NdLinearPolicy(input_dim=8, hidden_dim=128, output_dim=4)
    ...
    try:
        ...
        with open("lunarlander/rewards_log.json", "w") as f:
            json.dump(total_rewards, f)
        print("Training complete. Rewards saved to lunarlander/rewards_log.json")
